...
export default function Home(){
  ...
  return <main>
    <nav className="nav"><a className="brand" href="#inicio"><span className="brand-mark">ET</span><span>EL TANQUE <b>MOTORS</b></span></a><div className="nav-links"><a href="#inventario">Inventario</a><a href="#financiamiento">Financiamiento</a><a href="#contacto">Contacto</a></div></nav>
