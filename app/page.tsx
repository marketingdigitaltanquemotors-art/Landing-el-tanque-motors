...
const initial:Vehicle[] = [
  ...
  {name:'Ford Mustang GT',year:'2023',km:'12,850 km',price:899000,features:'Motor V8 5.0 L · Transmisión automática · Modos de manejo · Audio premium'},
  {name:'Toyota Tacoma',year:'2022',km:'35,200 km',price:720000,features:'Motor V6 · Tracción 4x4 · Cámara de reversa · Bedliner incluido'},
];
...
export default function Home(){
  ...
  function addVehicle(){setVehicles(list=>[...list,{name:'Nuevo vehículo',year:'2024',km:'0 km',price:350000,features:'Escribe aquí las características principales del vehículo.'}]);}
